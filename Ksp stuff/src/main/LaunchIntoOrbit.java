...
public class LaunchIntoOrbit {
	public static void main(final String[] args) throws IOException, RPCException, InterruptedException, StreamException {
		...
		Stream<Float> srbFuel = connection.addStream(stage2Resources, "amount", "SolidFuel");
